                ...
                child: Column(
                  children: [
                    ...
                    ElevatedButton(
                        ...
                        onPressed: () {
                          _pdb.ProinsertData(_txtname.text, _txtqa.text, _txtprice.text, _txtpurdate.text,int.parse(_controller.dataModal!.id!), 1);
                          getdata();
                          _txtpurdate.clear();
                          _txtname.clear();
                          _txtprice.clear();
                          _txtqa.clear();
                          Get.off(CustomerInfo());
                          Get.snackbar('Product Data Added Sucessfully', 'You Can Pay Now',
